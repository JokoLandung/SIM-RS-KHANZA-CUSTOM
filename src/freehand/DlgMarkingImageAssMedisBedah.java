 ...
 * @author perpustakaan
 */
public class DlgMarkingImageAssMedisBedah extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMarkingImageAssMedisBedah(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        setSize(885,674); 
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        try {
            ...
            Logger.getLogger(DlgMarkingImageAssMedisBedah.class.getName()).log(Level.SEVERE, null, ex);
        }
        Rectangle capture = 
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMarkingImageAssMedisBedah dialog = new DlgMarkingImageAssMedisBedah(new javax.swing.JFrame(), true);
