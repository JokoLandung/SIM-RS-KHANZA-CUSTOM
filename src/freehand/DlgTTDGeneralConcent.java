 ...
 * @author perpustakaan
 */
public class DlgTTDGeneralConcent extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgTTDGeneralConcent(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        setSize(300,300);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), ".:[ Tanda Tangan General Concent ]:.", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        try {
            ...
            Logger.getLogger(DlgTTDGeneralConcent.class.getName()).log(Level.SEVERE, null, ex);
        }
        Rectangle capture = 
            new Rectangle(Toolkit.getDefaultToolkit().getScreenSize());
            BufferedImage Image = r.createScreenCapture(panelGlass9.bounds());
        try {
            ImageIO.write(Image, "png", new File("tmpImageFreehand/ttdgeneralconcent"+TNoRM.getText()+".png"));
        } catch (IOException ex) {
            Logger.getLogger(DlgTTDGeneralConcent.class.getName()).log(Level.SEVERE, null, ex);
        }
        uploadImage("ttdgeneralconcent"+TNoRM.getText()+".png","imagefreehand/generalconcent");
        dispose();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgTTDGeneralConcent dialog = new DlgTTDGeneralConcent(new javax.swing.JFrame(), true);
